    ...
    <div class="container-fluid"> 
        <div class="row"> 
            <div class="col-12"> 
                ...
                <div class="card"> 
                    <div class="card-body"> 
                        <form action="/departemen/{{$departemen->id}}" method="POST" enctype="multipart/form-data">
                        @csrf 
                        @method('put')
                        <div class="form-row"> 
                        ...
                        <div class="form-row"> 
                            <div class="form-group col-md-6"> 
                                ...
                                name="nama_manager" 
                                value="{{ $departemen->nama_manager }}" placeholder="Masukkan Nama Manager"> 
                                @error('nama_manager') 
                                <div class="invalid-feedback"> 
                                    {{ $message }} 
                                </div> 
                            ...
                            <div class="form-group col-md-6"> 
                                ...
                                name="jumlah_pegawai" value="{{ $departemen->jumlah_pegawai }}" placeholder="Masukkan Jumlah Pegawai"> 
