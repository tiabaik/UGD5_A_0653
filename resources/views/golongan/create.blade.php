                    ...
                    <div class="card-body"> 
                        ...
                        <div class="form-row"> 
                            ...
                            <div class="form-group col-md-6"> 
                                ...
                                name="tunjangan_keluarga" value="{{ old('tunjangan_keluarga') }}" placeholder="Masukan Tujuangan Keluarga"> 
                        ...
                        <div class="form-group col-md-6"> 
                                ...
                                name="tunjangan_transport" value="{{ old('tunjangan_transport') }}" placeholder="Masukkan Transport"> 
                        ...
                        <div class="form-group col-md-6"> 
                                ...
                                name="tunjangan_makan" value="{{ old('tunjangan_makan') }}" placeholder="Masukkan Makan"> 
